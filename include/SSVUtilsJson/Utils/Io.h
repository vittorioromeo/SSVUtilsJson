...
namespace ssvuj
{
	...
	inline static Obj readFromString(const std::string& mStr)	{ Obj result; Reader reader; Internal::tryParse(result, reader, mStr); return result; }
	...
	inline static void writeToString(const Obj& mObj, std::string& mStr)				{ std::ostringstream o; writeToStream(mObj, o); mStr = o.str(); }
