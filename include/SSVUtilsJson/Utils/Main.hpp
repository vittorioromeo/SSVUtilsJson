...
namespace ssvuj
{
    ...
    {
        return Internal::isObjType<T>(mObj);
    }
    ...
    namespace Internal
    {
            ...
            const Obj& mArray, TArg& mArg, TArgs&... mArgs)
        {
            ...
            extrArrayHelper<TIdx + 1>(mArray, ssvu::fwd<TArgs&>(mArgs)...);
        }
            ...
            Obj& mArray, const TArg& mArg, const TArgs&... mArgs)
        {
            ...
            archArrayHelper<TIdx + 1>(
                mArray, ssvu::fwd<const TArgs&>(mArgs)...);
        }
            ...
            const Obj& mObj, const Key& mKey, TArg& mArg, TArgs&... mArgs)
        {
            ...
            extrObjHelper(mObj, ssvu::fwd<TArgs&>(mArgs)...);
        }
            ...
            Obj& mObj, const Key& mKey, TArg&& mArg, const TArgs&... mArgs)
        {
            ...
            archObjHelper(mObj, ssvu::fwd<const TArgs&>(mArgs)...);
        }
    }
    ...
    {
        Internal::extrArrayHelper<0>(mArray, ssvu::fwd<TArgs&>(mArgs)...);
    }
    ...
    {
        Internal::archArrayHelper<0>(mArray, ssvu::fwd<const TArgs&>(mArgs)...);
    }
    ...
    {
        Obj result;
        archArray(result, ssvu::fwd<const TArgs&>(mArgs)...);
        return result;
    }
    ...
    {
        Internal::extrObjHelper(mObj, ssvu::fwd<TArgs&>(mArgs)...);
    }
    ...
    {
        Internal::archObjHelper(mObj, ssvu::fwd<const TArgs&>(mArgs)...);
    }
    ...
    {
        Obj result;
        archObj(result, ssvu::fwd<const TArgs&>(mArgs)...);
        return result;
    }
    ...
    {
        extrArray(mObj, ssvu::fwd<TArgs&>(mArgs)...);
    }
    ...
    {
        archArray(mObj, ssvu::fwd<const TArgs&>(mArgs)...);
    }
    ...
    {
        extrObj(mObj, ssvu::fwd<TArgs&>(mArgs)...);
    }
    ...
    {
        archObj(mObj, ssvu::fwd<const TArgs&>(mArgs)...);
    }
}
