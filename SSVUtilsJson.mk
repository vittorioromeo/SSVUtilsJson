...
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)../jsoncpp/libs/mingw/libjson_mingw_libmt $(LibrarySwitch)../SSVUtils/lib/libSSVUtils-s 
ArLibs                 :=  "../jsoncpp/libs/mingw/libjson_mingw_libmt.a" "../SSVUtils/lib/libSSVUtils-s.a" 
LibPath                := $(LibraryPathSwitch). $(LibraryPathSwitch)../jsoncpp/libs/mingw/ $(LibraryPathSwitch)../SSVUtils/lib/ 
